...
*/
/**************************************************************************/
ER_RA8875::ER_RA8875(uint8_t CS, uint8_t RST)
  : ER_GFX(800, 480) {
  _cs = CS;
  _rst = RST;
}
...
*/
/**************************************************************************/
boolean ER_RA8875::begin(enum RA8875sizes s) {
  _size = s;
...
*/
/**************************************************************************/
void ER_RA8875::initialize(void) {
  /*
   writeCommand(0x01);
  writeData(0x01);
  delay(10);
...
*/
/**************************************************************************/
uint16_t ER_RA8875::height(void) {
  return _height;
}
...
*/
/**************************************************************************/
void ER_RA8875::textSetCursor(uint16_t x, uint16_t y) {
  /* Set cursor location */
  writeCommand(0x2A);
  writeData(x & 0xFF);
  writeCommand(0x2B);
...
*/
/**************************************************************************/
void ER_RA8875::textColor(uint16_t foreColor, uint16_t bgColor) {
  /* Set Fore Color */
  writeCommand(0x63);
...
*/
/**************************************************************************/
void ER_RA8875::textTransparent(uint16_t foreColor) {
  /* Set Fore Color */
  writeCommand(0x63);
  writeData((foreColor & 0xf800) >> 11);
  writeCommand(0x64);
...
*/
/**************************************************************************/
void ER_RA8875::textEnlarge(uint8_t scale) {
  if (scale > 3) scale = 3;
...
*/
/**************************************************************************/
void ER_RA8875::textWrite(const char *buffer, uint16_t len) {
...
*/
/**************************************************************************/
void ER_RA8875::graphicsMode(void) {
  writeCommand(RA8875_MWCR0);
  uint8_t temp = readData();
...
*/
/**************************************************************************/
boolean ER_RA8875::waitPoll(uint8_t regname, uint8_t waitflag) {
...
*/
/**************************************************************************/
void ER_RA8875::setXY(uint16_t x, uint16_t y) {
...
*/
/**************************************************************************/
void ER_RA8875::pushPixels(uint32_t num, uint16_t p) {
...
*/
/**************************************************************************/
void ER_RA8875::drawPixel(int16_t x, int16_t y, uint16_t color) {
  writeReg(RA8875_CURH0, x);
  writeReg(RA8875_CURH1, x >> 8);
  writeReg(RA8875_CURV0, y);
  writeReg(RA8875_CURV1, y >> 8);
...
*/
/**************************************************************************/
void ER_RA8875::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint16_t color) {
  /* Set X */
  writeCommand(0x91);
  writeData(x0);
  writeCommand(0x92);
...
*/
/**************************************************************************/
void ER_RA8875::drawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::drawFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::drawRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::fillScreen(uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::fillCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::drawEllipse(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::fillEllipse(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::drawCurve(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint8_t curvePart, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::fillCurve(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint8_t curvePart, uint16_t color) {
...
*/
/**************************************************************************/
void ER_RA8875::circleHelper(int16_t x0, int16_t y0, int16_t r, uint16_t color, bool filled) {
  /* Set X */
  writeCommand(0x99);
  writeData(x0);
  writeCommand(0x9a);
...
*/
/**************************************************************************/
void ER_RA8875::rectHelper(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color, bool filled) {
  /* Set X */
  writeCommand(0x91);
  writeData(x);
  writeCommand(0x92);
...
*/
/**************************************************************************/
void ER_RA8875::triangleHelper(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color, bool filled) {
  /* Set Point 0 */
  writeCommand(0x91);
  writeData(x0);
  writeCommand(0x92);
...
*/
/**************************************************************************/
void ER_RA8875::ellipseHelper(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint16_t color, bool filled) {
  /* Set Center Point */
  writeCommand(0xA5);
  writeData(xCenter);
  writeCommand(0xA6);
...
*/
/**************************************************************************/
void ER_RA8875::curveHelper(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint8_t curvePart, uint16_t color, bool filled) {
  /* Set Center Point */
  writeCommand(0xA5);
  writeData(xCenter);
  writeCommand(0xA6);
...
*/
/**************************************************************************/
void ER_RA8875::GPIOX(boolean on) {
  if (on)
...
*/
/**************************************************************************/
void ER_RA8875::PWM1out(uint8_t p) {
...
*/
/**************************************************************************/
void ER_RA8875::PWM2out(uint8_t p) {
...
*/
/**************************************************************************/
void ER_RA8875::PWM1config(boolean on, uint8_t clock) {
  if (on) {
...
*/
/**************************************************************************/
void ER_RA8875::PWM2config(boolean on, uint8_t clock) {
  if (on) {
...
*/
/**************************************************************************/
void ER_RA8875::touchEnable(boolean on) {
  if (on) {
    /* Enable Touch Panel (Reg 0x70) */
    writeReg(RA8875_TPCR0, RA8875_TPCR0_ENABLE | RA8875_TPCR0_WAIT_4096CLK | RA8875_TPCR0_WAKEDISABLE | RA8875_TPCR0_ADCCLK_DIV4);  // 10mhz max!
...
*/
/**************************************************************************/
boolean ER_RA8875::touched(void) {
...
*/
/**************************************************************************/
boolean ER_RA8875::touchRead(uint16_t *x, uint16_t *y) {
  uint16_t tx, ty;
  uint8_t temp;
...
*/
/**************************************************************************/
void ER_RA8875::displayOn(boolean on) {
  if (on)
...
*/
/**************************************************************************/
void ER_RA8875::sleep(boolean sleep) {
  if (sleep)
...
*/
/**************************************************************************/
void ER_RA8875::writeReg(uint8_t reg, uint8_t val) {
  writeCommand(reg);
  writeData(val);
}
...
*/
/**************************************************************************/
uint8_t ER_RA8875::readReg(uint8_t reg) {
  writeCommand(reg);
  return readData();
}
...
*/
/**************************************************************************/
void ER_RA8875::writeData(uint8_t d) {
  digitalWrite(_cs, LOW);
  SPI.transfer(RA8875_DATAWRITE);
  SPI.transfer(d);
  digitalWrite(_cs, HIGH);
...
*/
/**************************************************************************/
uint8_t ER_RA8875::readData(void) {
  digitalWrite(_cs, LOW);
...
*/
/**************************************************************************/
void ER_RA8875::writeCommand(uint8_t d) {
  digitalWrite(_cs, LOW);
...
*/
/**************************************************************************/
uint8_t ER_RA8875::readStatus(void) {
  digitalWrite(_cs, LOW);
