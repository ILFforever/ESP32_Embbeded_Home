...
┌────────────────────┐  ┌──────────────────────┐  ┌──────────────────────┐  ┌────────────────┐
│  Mesh Sensors      │  │   Doorbell System    │  │   Main Hub System    │  │   Door Lock    │
│                    │  │                      │  │                      │  │  (WiFi Direct) │
│ ┌────────────────┐ │  │  ┌────────────────┐  │  │  ┌────────────────┐  │  │ ┌────────────┐ │
│ │ Room Sensors   │ │  │  │  Camera (S3)   │  │  │  │ Main Mesh Hub  │◄─┼──┼─┤ ESP32 Lock │ │
│ │ - Temperature  │ │  │  │  - Face Recog  │  │  │  │ - PMS5003      │  │  │ │ - Servo    │ │
│ │ - Humidity     │ │  │  │  - ESP-WHO AI  │  │  │  │ - DHT11        │  │  │ │ - LED      │ │
│ │ - Gas/CO       │─┼──┼─▶│  └──────┬───────┘  │  │  └────────┬───────┘  │  │ └────────────┘ │
│ └────────────────┘ │  │  │         │ SPI      │  │           │ UART     │  │                │
│                    │  │  │         ▼          │  │           ▼          │  │                │
│  Painless Mesh     │  │  │  ┌────────────────┐  │  │  ┌────────────────┐  │  │                │
│  ESP-NOW Protocol  │  │  │  │ Doorbell LCD   │  │  │  │  Main LCD      │  │  │                │
└────────────────────┘  │  │  │ - Display      │  │  │  │  - Gateway     │  │  │                │
         │              │  │  │ - NFC Scanner  │  │  │  │  - Display     │  │  │                │
         │              │  │  │ - Audio Amp    │  │  │  │  - Amplifier   │  │  │                │
         │              │  │  └────────┬───────┘  │  │  └────────┬───────┘  │  │                │
...
DATA FLOW:
  Sensors → Main Mesh Hub → Main LCD ──┐
  Doorbell Camera → Doorbell LCD ──────┼──→ Cloud Backend → Web Dashboard
  Door Lock ───────────────────────────┘
```
